...
User Function CADZSM()
	...
	Private cUSCAR	:= SuperGetMV("AL_USERCAR"	, 		, "000001")
	...
	If __cUserId $ cUSADM .Or. __cUserId $ cUSCAR
		...
		If __cUserId $ cUSADM .And. __cUserId $ cUSCAR
		
			cFiltro:= ""
		
		ElseIf __cUserId $ cUSADM 
		
			cFiltro:= "(ZM_BCC = '' Or ZM_BCC = 'CAP')"
		
		ElseiF __cUserId $ cUSCAR
	...
	mBrowse(6,1,22,75,"SZM",,,,,,aCores,,,,,.F.,,,cFiltro)
